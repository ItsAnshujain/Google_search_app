...
import { pagination, quickLinks } from "../utils/Constants";
...
const Pagination = ({ queries }) => {
  ...
  return (
    <div className="flex flex-col max-w-[700px] py-14 items-center">
      <div className="relative text-[#4285f4]">
        {queries.previousPage && (
          <div
            className="absolute left-[-30px]  md:left-[-40px] top-[18px]"
            onClick={() =>
        ...
        {queries.nextPage && (
          <div
            className="absolute right-[-30px]  md:right-[-40px] top-[18px]"
            onClick={() =>
